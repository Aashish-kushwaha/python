...
print(
    file.readlines())  # this function take everyline and put them into a list and then we can print which ever line we want
print(file.readlines()[0])  # reads the first line of the file

# we can also use for loop and readlines to display the content of file
